...
@Component({
  selector: 'app-hdis-chart',
  standalone: true,
  templateUrl: './hdis-chart.component.html',
  styleUrl: './hdis-chart.component.css',
})
export class HdisChartComponent implements AfterViewInit, OnChanges {
